...
Microsoft Edge extension written by Alec Breen. It is not affiliated with, endorsed by,
...
Microsoft Edge's local extension storage so that the user can remain signed in. It is
...
clear it by removing the extension from Microsoft Edge.
